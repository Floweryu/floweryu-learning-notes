...
![image-20221120134704161](./assets/image-20221120134704161.png)
...
![image-20221120134748675](./assets/image-20221120134748675.png)
...
![image-20221120134957356](./assets/image-20221120134957356.png)
...
![image-20221120135327670](./assets/image-20221120135327670.png)

#### 5. 异步IO模型 (AIO)

用户线程通过系统调用，向内核注册某个IO操作。内核在整个IO操作完成后（包含将数据从内核复制到用户空间），通知用户程序，用户执行后续业务操作。

![image-20221120135604221](./assets/image-20221120135604221.png)
...
![image-20221120151734901](./assets/image-20221120151734901.png)
...
<img src="./assets/image-20221120151852997.png" alt="image-20221120151852997" style="zoom:80%;" />
...
<img src="./assets/image-20221120152204203.png" alt="image-20221120152204203" style="zoom:80%;" />
...
![image-20221120154127881](./assets/image-20221120154127881.png)
...
![image-20221120185449229](./assets/image-20221120185449229.png)

## 四.. Netty中的Reactor反应器

NioEventLoop类下面有两个java成员属性(如下图)，可以看出和前面思想一致：一个反应器拥有一个线程，负责一个Java NIO选择器的IO事件轮询。

![image-20221120191538142](./assets/image-20221120191538142.png)

## 五.. Netty中的Handler处理器

![image-20221120194025342](./assets/image-20221120194025342.png)



Netty入站处理（以OP_READ事件为例）：在通道发生OP_READ事件后，会被反应器EventLoop查询到，然后分发给通道入站处理器，调用read()方法读取通道里面的数据。

![image-20221120194347158](./assets/image-20221120194347158.png)
...
![image-20221120193942100](./assets/image-20221120193942100.png)
...
![image-20221120195229751](./assets/image-20221120195229751.png)
...
![image-20221120204332882](./assets/image-20221120204332882.png)
...
![image-20221120224621647](./assets/image-20221120224621647.png)
...
![image-20221120224736550](./assets/image-20221120224736550.png)
...
![image-20221120230052903](./assets/image-20221120230052903.png)
...
![image-20221120230905463](./assets/image-20221120230905463.png)
...
![image-20221121170704941](./assets/image-20221121170704941.png)
...
![image-20221121194642294](./assets/image-20221121194642294.png)
...
![image-20221121194935963](./assets/image-20221121194935963.png)
...
![image-20221121195609859](./assets/image-20221121195609859.png)
